...
const requests = {
  ...
  OffsetDelete: noImplementedRequestDefinitions,
  ...
  DescribeCluster: noImplementedRequestDefinitions,
  DescribeProducers: noImplementedRequestDefinitions,
  ...
  DescribeTransactions: noImplementedRequestDefinitions,
  ListTransactions: noImplementedRequestDefinitions,
  ...
  ShareGroupHeartbeat: noImplementedRequestDefinitions,
  ShareGroupDescribe: noImplementedRequestDefinitions,
  ShareFetch: noImplementedRequestDefinitions,
  ShareAcknowledge: noImplementedRequestDefinitions,
  // Kafka 4.1+
  AddRaftVoter: noImplementedRequestDefinitions,
  RemoveRaftVoter: noImplementedRequestDefinitions,
  // Kafka 4.2+
  UpdateRaftVoter: noImplementedRequestDefinitions,
  ReadShareGroupStateSummary: noImplementedRequestDefinitions,
}
